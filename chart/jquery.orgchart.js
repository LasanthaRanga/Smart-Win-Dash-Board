    ...
    function Node(data) {
        ...
        this.formatNode = function (opts) {
            ...
            if (typeof data.name !== 'undefined') {
                nameString = '<h2><strong>' + self.data.side + ' </strong>  SW: ' + self.data.uid + '<br>  PIN: ' + self.data.id + '<br>' + self.data.name + '</h2>';
            }

            if (typeof data.pointA !== 'undefined') {
                nameString += "<br>  Point-A : " + self.data.pointA;
                nameString += "<br>  Point-B  : " + self.data.pointB;
            }
            ...
            if (opts.showControls) {
                var buttonsHtml = "<div class='org-add-button'>" + opts.newNodeText + "</div> <div class='org-del-button'></div><div class='org-del-button'></div>";
            ...
            if (data.active > 0) {
                ...
                return "<div class='node'  style='border: 3px solid #c50000;'  node-id='" + this.data.id + "'>" + nameString + descString + buttonsHtml + "</div>";
            }
