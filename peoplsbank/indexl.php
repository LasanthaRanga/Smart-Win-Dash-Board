...
<head>
	...
	<script type='text/javascript'>
		function pos(order, status, description) {
			$.ajax({
				method: "POST",
				url: "https://api.smartwinent.com/onpay/updateby_orderid",
				data: {
					order: order,
					status: status
				},
				success: function(data) {
					...
					if (status == 1) {
						console.log('1111111');
						window.location.href = "https://sw.smartwinent.com/#/user-profile";
					} else if (status == 2) {
						console.log('2222222');
						Swal.fire({
							icon: 'error',
		...
		<div class="col d-flex justify-content-center">
			<div class="card text-center">
				...
				<div class="card-body">
					...
					if (isset($_REQUEST["ReasonCodeDesc"])) {
					...
					<form id='FrmHtmlCheckout' name='FrmHtmlCheckout' action='https://pg.peoplesbank.lk/OrderProcessingEngine/RedirectLink.aspx' method='post'>
						...
						<input id='MerRespURL' type='hidden' value='https://sw.smartwinent.com/peoplsbank/index.php' name='MerRespURL'>
