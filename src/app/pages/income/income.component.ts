...
export class IncomeComponent implements OnInit {
  ...
  getPointComDates() {
    ...
    this.api.post(this.urlInvoice + 'getFullIncom', { from: datef, to: datet }, data => {
  ...
  getPointExpense() {
    ...
    const datef = pipe.transform(this.from, 'yyyy-MM-dd');
    const datet = pipe.transform(this.to, 'yyyy-MM-dd');
    this.api.post(this.urlInvoice + 'getPointExpenses', { from: datef, to: datet }, data => {
  ...
  getIntoExpense() {
    ...
    const datef = pipe.transform(this.from, 'yyyy-MM-dd');
    const datet = pipe.transform(this.to, 'yyyy-MM-dd');
    this.api.post(this.urlInvoice + 'getCommitionExpenses', { from: datef, to: datet }, data => {
